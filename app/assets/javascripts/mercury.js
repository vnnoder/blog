...
$(window).bind('mercury:ready', function() { 
		var save_url = $('#mercury_iframe').contents().find('div#save_url');		
		Mercury.saveUrl = save_url.data('save-url');
	});
$(window).bind('mercury:saved', function(){
	var redirect_url = $('#mercury_iframe').contents().find('div#redirect_url');	
	window.location = redirect_url.data('redirect-url');
});